...
symbols=("BTCUSDT", "ETHUSDT", "ADAUSDT", "BNBUSDT", "SOLUSDT", "DOTUSDT", "UNIUSDT", "LTCUSDT","LINKUSDT","MATICUSDT","FILUSDT","AVAXUSDT","VETUSDT","XLMUSDT","TRXUSDT","EOSUSDT","XMRUSDT","ATOMUSDT","AAVEUSDT","CAKEUSDT","MIOTAUSDT","GRTUSDT",) # add symbols here to download
